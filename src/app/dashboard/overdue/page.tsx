...
export default function OverduePage() {
  ...
  const handleSentAllCancellation = () => {
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold text-gray-900">Konfirmasi Kirim Penalti</h2>
              <button
            ...
            <p className="text-sm text-gray-500 mt-1">
              {overduePayments.length} penalti akan dikirim
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-2">
              {overduePayments.length} penalti berhasil dikirim
            </p>
            <p className="text-sm text-gray-500">
              Email penalti telah dikirim ke semua member
            </p>
          </div>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        />
        <button
          onClick={handleSentAllCancellation}
        ...
        >
          <div className="flex items-start justify-between">
            <div className="p-3 rounded-lg bg-danger/10 text-danger group-hover:bg-danger group-hover:text-white transition-colors">
              <Send className="w-6 h-6" />
            </div>
          </div>
          <div className="mt-4">
            <p className="text-3xl font-bold text-gray-900">Kirim</p>
            <p className="text-sm text-gray-500 mt-1">Sent Cancellation</p>
          </div>
        </button>
      </div>
